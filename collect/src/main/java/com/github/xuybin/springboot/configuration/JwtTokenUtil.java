...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(UserDetails userDetails, Device device,Date createdDate) {
        Map<String, Object> claims = new HashMap<>();
        return doGenerateToken(claims, userDetails.getUsername(), generateAudience(device),createdDate);
    }
    ...
    public Boolean validateToken(String token, DBUserDetails dbUserDetails) {
